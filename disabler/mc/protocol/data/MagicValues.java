package disabler.mc.protocol.data;

import disabler.mc.protocol.data.game.*;
import disabler.mc.protocol.data.game.advancement.Advancement;
import disabler.mc.protocol.data.game.entity.Effect;
import disabler.mc.protocol.data.game.entity.EntityStatus;
import disabler.mc.protocol.data.game.entity.EquipmentSlot;
import disabler.mc.protocol.data.game.entity.attribute.AttributeType;
import disabler.mc.protocol.data.game.entity.attribute.ModifierOperation;
import disabler.mc.protocol.data.game.entity.attribute.ModifierType;
import disabler.mc.protocol.data.game.entity.metadata.MetadataType;
import disabler.mc.protocol.data.game.entity.player.*;
import disabler.mc.protocol.data.game.entity.type.GlobalEntityType;
import disabler.mc.protocol.data.game.entity.type.MobType;
...
import disabler.mc.protocol.data.game.entity.type.object.MinecartType;
import disabler.mc.protocol.data.game.entity.type.object.ObjectType;
import disabler.mc.protocol.data.game.scoreboard.*;
import disabler.mc.protocol.data.game.setting.ChatVisibility;
import disabler.mc.protocol.data.game.setting.Difficulty;
import disabler.mc.protocol.data.game.statistic.GenericStatistic;
import disabler.mc.protocol.data.game.window.*;
import disabler.mc.protocol.data.game.window.property.AnvilProperty;
import disabler.mc.protocol.data.game.window.property.BrewingStandProperty;
import disabler.mc.protocol.data.game.window.property.EnchantmentTableProperty;
import disabler.mc.protocol.data.game.window.property.FurnaceProperty;
import disabler.mc.protocol.data.game.world.Particle;
import disabler.mc.protocol.data.game.world.WorldBorderAction;
...
import disabler.mc.protocol.data.game.world.block.value.*;
import disabler.mc.protocol.data.game.world.effect.ParticleEffect;
import disabler.mc.protocol.data.game.world.effect.SmokeEffectData;
import disabler.mc.protocol.data.game.world.effect.SoundEffect;
import disabler.mc.protocol.data.game.world.map.MapIconType;
import disabler.mc.protocol.data.game.world.notify.ClientNotification;
import disabler.mc.protocol.data.game.world.notify.DemoMessageValue;
import disabler.mc.protocol.data.game.world.notify.EnterCreditsValue;
import disabler.mc.protocol.data.game.world.sound.BuiltinSound;
import disabler.mc.protocol.data.game.world.sound.SoundCategory;
