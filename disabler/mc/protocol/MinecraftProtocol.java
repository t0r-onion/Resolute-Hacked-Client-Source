...
import disabler.mc.auth.service.AuthenticationService;
import disabler.mc.protocol.data.SubProtocol;
import disabler.mc.protocol.packet.handshake.client.HandshakePacket;
import disabler.mc.protocol.packet.ingame.client.*;
import disabler.mc.protocol.packet.ingame.client.player.*;
import disabler.mc.protocol.packet.ingame.client.window.*;
import disabler.mc.protocol.packet.ingame.client.world.*;
import disabler.mc.protocol.packet.ingame.server.*;
import disabler.mc.protocol.packet.ingame.server.entity.*;
import disabler.mc.protocol.packet.ingame.server.entity.player.*;
import disabler.mc.protocol.packet.ingame.server.entity.spawn.*;
import disabler.mc.protocol.packet.ingame.server.scoreboard.ServerDisplayScoreboardPacket;
import disabler.mc.protocol.packet.ingame.server.scoreboard.ServerScoreboardObjectivePacket;
import disabler.mc.protocol.packet.ingame.server.scoreboard.ServerTeamPacket;
import disabler.mc.protocol.packet.ingame.server.scoreboard.ServerUpdateScorePacket;
import disabler.mc.protocol.packet.ingame.server.window.*;
import disabler.mc.protocol.packet.ingame.server.world.*;
...
import disabler.packetlib.Server;
import disabler.packetlib.Session;
import disabler.packetlib.crypt.AESEncryption;
import disabler.packetlib.crypt.PacketEncryption;
import disabler.packetlib.packet.DefaultPacketHeader;
import disabler.packetlib.packet.PacketHeader;
