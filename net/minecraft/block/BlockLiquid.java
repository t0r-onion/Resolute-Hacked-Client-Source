...
public abstract class BlockLiquid extends Block
{
    ...
    {
        EventLiquidBB eventLiquidBB = new EventLiquidBB(this, pos, null);
        Resolute.onEvent(eventLiquidBB);
        if (!eventLiquidBB.isCancelled()) {
            return eventLiquidBB.getAxisAlignedBB();
        }
        return null;
    }
