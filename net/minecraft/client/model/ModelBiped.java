...
import vip.Resolute.modules.impl.render.Emote;
...
public class ModelBiped extends ModelBase
{
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn)
    {
        ...
        if(Emote.enabled && Emote.mode.is("Dab") && entityIn.equals(Minecraft.getMinecraft().thePlayer) && Minecraft.getMinecraft().gameSettings.thirdPersonView > 0) {
        ...
        if(Emote.enabled && Emote.mode.is("Zombie") && entityIn.equals(Minecraft.getMinecraft().thePlayer) && Minecraft.getMinecraft().gameSettings.thirdPersonView > 0) {
        ...
        if(Emote.enabled && Emote.mode.is("Panic") && entityIn.equals(Minecraft.getMinecraft().thePlayer) && Minecraft.getMinecraft().gameSettings.thirdPersonView > 0) {
            this.bipedHead.rotateAngleX = 0.0f;
            this.bipedHead.rotateAngleY = 0.0f;
        ...
        if(Emote.enabled && Emote.mode.is("Bedrock") && entityIn.equals(Minecraft.getMinecraft().thePlayer) && Minecraft.getMinecraft().gameSettings.thirdPersonView > 0) {
            this.bipedHead.rotateAngleX = 0.0f;
            this.bipedHead.rotateAngleY = 0.0f;
            this.bipedRightArm.rotateAngleX = -100.75f;
            this.bipedRightArm.rotateAngleY = -0.0f;
            this.bipedLeftArm.rotateAngleX = -100.75f;
            this.bipedLeftArm.rotateAngleY = -0f;
        }
        if(Emote.enabled && Emote.mode.is("Autist") && entityIn.equals(Minecraft.getMinecraft().thePlayer) && Minecraft.getMinecraft().gameSettings.thirdPersonView > 0) {
            this.bipedHead.rotateAngleX = 0.0f;
            this.bipedHead.rotateAngleY = 0.0f;
            this.bipedRightArm.rotateAngleX = -100.50f;
            this.bipedRightArm.rotateAngleY = -0.0f;
            this.bipedRightLeg.rotateAngleX = -100.50f;
            this.bipedLeftLeg.rotateAngleY = -0.0f;
            this.bipedLeftLeg.rotateAngleX = -100.50f;

            this.bipedLeftArm.rotateAngleX = -100.50f;
            this.bipedLeftArm.rotateAngleY = -0f;
        }
