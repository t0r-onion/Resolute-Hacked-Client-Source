...
import vip.Resolute.util.render.SplashScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private TheAlteningAuthentication altening = TheAlteningAuthentication.mojang();
    ...
    private void startGame() throws LWJGLException, IOException, NoSuchAlgorithmException {
        ...
        this.ctm = new TextureManager(getResourceManager());
        SplashScreen.drawSplash(ctm);
        ...
        //splashScreen.progress(3, "Initializing");
        ...
        //splashScreen.progress(1, "Setting up Models...");
        this.mcResourceManager.registerReloadListener(this.modelManager);
        //splashScreen.progress(2, "Setting up Resources...");
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        //splashScreen.progress(3, "Setting up Items...");
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        //splashScreen.progress(4, "Setting up Renders...");
        this.itemRenderer = new ItemRenderer(this);
        //splashScreen.progress(5, "Setting up Item Renderers...");
        ...
        //splashScreen.progress(6, "Setting up Global...");
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new LoginScreen(), this, this.serverName, this.serverPort));
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + Resolute.fullname);
    ...
    {
        Resolute.onEvent(new EventTick());
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Resolute.getInstance().getDiscordRP().update("Singleplayer", "In Game" + " | " + "UUID: " + Resolute.instance.uuid);
    }
