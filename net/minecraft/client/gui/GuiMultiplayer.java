...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        Resolute.getInstance().getDiscordRP().update("Idle", "Server selection");
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(this.btnDeleteServer = new GuiButton(2, this.width / 2 - 74, this.height - 28, 70, 20, EnumChatFormatting.RED + I18n.format("selectServer.delete", new Object[0])));
        ...
        this.buttonList.add(this.btnSelectServer = new GuiButton(1, this.width / 2 - 154, this.height - 52, 100, 20, EnumChatFormatting.GREEN + I18n.format("selectServer.select", new Object[0])));
        ...
        //this.buttonList.add(new GuiButton(99, 5, 5, 90, 20, "Proxies"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            {
                //this.mc.displayGuiScreen(new GuiProxy());
            }
