...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest>
{
    ...
    public void renderTileEntityAt(TileEntityChest te, double x, double y, double z, float partialTicks, int destroyStage)
    {
        ...
        if (te.adjacentChestZNeg == null && te.adjacentChestXNeg == null)
        {
            ...
            if(ChestESP.enabled && ChestESP.mode.is("Chams")) {
                final boolean visibleFlat = ChestESP.visibleFlat.isEnabled();
                final boolean occludedFlat = ChestESP.occludedFlat.isEnabled();
                final int visibleColor = ChestESP.visibleColor.getColor();
                final int occludedColor = ChestESP.occludedColor.getColor();
