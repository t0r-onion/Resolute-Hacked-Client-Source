...
public class WorldRenderer
{
    ...
    public WorldRenderer color(int hex) {
        return color4i(hex >> 16 & 0xFF, hex >> 8 & 0xFF, hex & 0xFF, hex >> 24 & 0xFF);
    }

    public WorldRenderer color4i(int p_181669_1_, int p_181669_2_, int p_181669_3_, int p_181669_4_) {
    if (this.needsUpdate)
        return this;
    int i = this.vertexCount * this.vertexFormat.getNextOffset() + this.vertexFormat.func_181720_d(this.field_181678_g);
    switch (WorldRenderer.WorldRenderer$2.field_181661_a[this.field_181677_f.getType().ordinal()]) {
