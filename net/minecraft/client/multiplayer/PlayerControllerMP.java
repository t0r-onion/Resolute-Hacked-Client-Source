...
import vip.Resolute.util.world.Vec3dUtils;
...
public class PlayerControllerMP
{
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing)
    {
        ...
        EventBlockDamaged event = new EventBlockDamaged(posBlock);
    ...
    {
        if(Reach.enabled) {
            //return (float) Reach.reach.getValue();
        }
...
//						return false;
    ...
    public void onPlayerRightClick(EntityPlayerSP thePlayer, WorldClient theWorld, ItemStack stack, BlockPos position,
                                   EnumFacing face, Vec3dUtils vec3d) {
