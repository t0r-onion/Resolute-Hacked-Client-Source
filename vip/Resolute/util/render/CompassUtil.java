...
public class CompassUtil {
    ...
    public float scale;
    public int accuracy;
    MinecraftFontRenderer yahei28U = FontUtil.clientfont;
    MinecraftFontRenderer yahei18U = FontUtil.clientsmall;
    MinecraftFontRenderer yahei22U = FontUtil.clientmedium;
        ...
        for (Degree d : degrees) {
            ...
            if (d.type == 3 && opacity != 16777215) {
                ...
                this.yahei22U.drawString(d.text, completeLocation,
                        -75 + 100 + this.yahei28U.getHeight() / 2 - this.yahei22U.getHeight() / 2,
                        opacity(sr, completeLocation));
                subCardinals++;
            }
