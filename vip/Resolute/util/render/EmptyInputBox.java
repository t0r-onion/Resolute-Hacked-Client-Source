    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                j1 = (int) FontUtil.moon.drawString(s1, (float) l, (float) i1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = (int)  FontUtil.moon.drawString(s.substring(j), (float) j1, (float) i1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    FontUtil.moon.drawString("_", (float) k1, (float) i1, i);
                }
            }
