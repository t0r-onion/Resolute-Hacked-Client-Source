...
public class ScrollingText {
    ...
    public void render(float x, float y) {
        ...
        Depth.render(518);
        RenderUtils.rectangle((double)x, (double)y, (double)(x + (float)this.width), (double)(y + (float)this.height), Colors.getColor(175));
        Depth.post();
        if (this.offset > 0.0F) {
            GlStateManager.pushMatrix();
            RenderUtils.drawGradientSideways((double)x, (double)y, (double)(x + 5.0F), (double)(y + (float)this.height), this.backgroundColor, this.transparentBackgroundColor);
        ...
        if (this.stringWidth > (float)this.width && this.offset < this.stringWidth - (float)this.width) {
            GlStateManager.pushMatrix();
            RenderUtils.drawGradientSideways((double)(x + (float)this.width - 5.0F), (double)y, (double)(x + (float)this.width), (double)(y + (float)this.height), this.transparentBackgroundColor, this.backgroundColor);
            GlStateManager.color(0.0F, 0.0F, 0.0F, 0.0F);
            GlStateManager.popMatrix();
        }
