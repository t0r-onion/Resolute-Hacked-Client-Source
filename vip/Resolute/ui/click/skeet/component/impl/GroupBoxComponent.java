...
public final class GroupBoxComponent extends Component {
    ...
    public void drawComponent(ScaledResolution resolution, int mouseX, int mouseY) {
        ...
        float length = (float) SkeetUI.GROUP_BOX_HEADER_RENDERER.getStringWidth(this.name);
        Gui.drawRect((double)x, (double)y, (double)(x + width + 20), (double)(y + height), SkeetUI.getColor(789516));
        Gui.drawRect((double)(x + 0.5F), (double)(y + 0.5F), (double)(x + width - 0.5F + 20), (double)(y + height - 0.5F), SkeetUI.getColor(2631720));
        Gui.drawRect((double)(x + 4.0F), (double)y, (double)(x + 4.0F + length + 2.0F + 20), (double)(y + 1.0F), SkeetUI.getColor(1513239));
        Gui.drawRect((double)(x + 1.0F), (double)(y + 1.0F), (double)(x + width - 1.0F + 20), (double)(y + height - 1.0F), SkeetUI.getColor(1513239));
        ...
        while(true) {
            ...
            if (component.getWidth() >= 80.333336F) {
                ...
                component.setX(left ? 3.0F : 69.166668F);
