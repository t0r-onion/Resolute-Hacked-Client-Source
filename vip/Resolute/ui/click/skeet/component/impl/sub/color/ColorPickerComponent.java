...
public abstract class ColorPickerComponent extends ButtonComponent implements PredicateComponent, ExpandableComponent {
    ...
    public void drawComponent(ScaledResolution lockedResolution, int mouseX, int mouseY) {
        ...
        if (this.isExpanded()) {
            ...
            int color2 = Color.HSBtoRGB(this.hue, this.saturation, this.brightness);
            int r = color2 >> 16 & 255;
            int g = color2 >> 8 & 255;
            int b = color2 & 255;
            ...
            RenderUtils.drawGradientRect((double)colorPickerLeft, (double)alphaSliderTop, (double)colorPickerRight, (double)alphaSliderBottom, true, (new Color(r, g, b, 0)).getRGB(), (new Color(r, g, b, Math.min(guiAlpha, 255))).getRGB());
    ...
    private void drawColorPickerRect(float left, float top, float right, float bottom) {
        ...
        RenderUtils.drawGradientRect((double)left, (double)top, (double)right, (double)bottom, true, SkeetUI.getColor(16777215), hueBasedColor);
