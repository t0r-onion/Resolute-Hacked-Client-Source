...
public final class ModuleComponent extends ExpandableComponent
{
    ...
    public ModuleComponent(final Component parent, final Module module, final int x, final int y, final int width, final int height) {
        ...
        for (final Setting property : properties) {
            ...
            if (property instanceof BooleanSetting) {
                ...
                component = new ColorPropertyComponent(this, (ColorSetting) property, propertyX, propertyY, width - 2, 15);
            }
                ...
                component = new EnumBoxProperty(this, (ModeSetting) property, propertyX, propertyY, width - 2, 15);
            }
            if (component != null) {
    ...
    public void drawComponent(final ScaledResolution scaledResolution, final int mouseX, final int mouseY) {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.binding ? "Press A Key..." : this.getName(), (float)(x + 2), y + height / 2.0f - 4.0f, this.module.isEnabled() ? ((int) ClickGUI.color.getColor()) : new Color(255, 255, 255).getRGB());
        if (this.canExpand()) {
