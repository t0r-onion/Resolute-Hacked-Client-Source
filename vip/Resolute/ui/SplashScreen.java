...
public class SplashScreen {
    ...
    public void drawProgress(ScaledResolution sc) {
        RenderUtils.drawRect(0,0, sc.getScaledWidth(), sc.getScaledHeight(), new Color(18,18,18).getRGB());
        int width = 200;
        int progress = (this.progress / max) * width;
        RenderUtils.drawRect(sc.getScaledWidth() / 2f - 100, sc.getScaledHeight() / 2f - 8, sc.getScaledWidth() / 2f + 100, sc.getScaledHeight() / 2f + 8, 0xff242424);
        RenderUtils.drawRect(sc.getScaledWidth() / 2f - 100 + 2, sc.getScaledHeight() / 2f - 8 + 2, sc.getScaledWidth() / 2f - 100 + progress - 2, sc.getScaledHeight() / 2f + 8 - 2, 0xff910707);
    }
